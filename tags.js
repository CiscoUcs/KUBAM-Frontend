...
riot.tag2('hosts', '<div class="svrGrpServers"> <div class="top-actions"> <fancy-dropdown inputid="actions" class="table-input"> <option value="none">Actions</option> <option value="buildimage">Build Image</option> <option value="deploy">Deploy</option> </fancy-dropdown> </div> <table-search></table-search> <div class="table"> <div class="tr"> <div class="th checkbox_width"> <input type="checkbox" id="select_all" onclick="{changeSelection}"> </div> <div class="th">Server</div> <div class="th hostname_width">Hostname</div> <div class="th dropdown_width">Operating System</div> <div class="th dropdown_width">Network</div> <div class="th ip_width">Server IP</div> </div> <div class="tr" each="{host in this.opts.store.getState().hosts}"> <div class="td-host checkbox_width"> <input type="checkbox" class="hostcheckboxes"> </div> <div class="td-host">Servergroup Servername</div> <div class="td-host hostname_width"> <input type="text" placeholder="{host.name}"> </div> <div class="td-host dropdown_width"> <ul class="main-navigation"> <li><a href="#">No OS selected</a> <ul> <li><a href="#">Windows 2016</a></li> <li><a href="#">RedHat</a> <ul> <li><a href="#">No Kubernetes</a></li> <li><a href="#">Kubernetes Master</a></li> <li><a href="#">Kubernetes Worker</a></li> </ul> </li> <li><a href="#">CentOS</a> <ul> <li><a href="#">No Kubernetes</a></li> <li><a href="#">Kubernetes Master</a></li> <li><a href="#">Kubernetes Worker</a></li> </ul> </li> </ul> </li> </ul> </div> <div class="td-host dropdown_width"> <ul class="main-navigation"> <li><a href="#">No Network selected</a> <ul> <li><a href="#">Network 1</a></li> <li><a href="#">Network 2</a></li> </ul> </li> </ul> </div> <div class="td-host ip_width"> <input type="text" placeholder="{host.ip}"> </div> </div> </div> <add-button onclick="{addHost}">Add Host</add-button>', 'hosts .checkbox_width,[data-is="hosts"] .checkbox_width{ width: 20px; } hosts .hostname_width,[data-is="hosts"] .hostname_width{ width: 140px; } hosts .ip_width,[data-is="hosts"] .ip_width{ width: 120px; } hosts .dropdown_width,[data-is="hosts"] .dropdown_width{ width: 160px; } hosts .top-actions,[data-is="hosts"] .top-actions{ margin-bottom: 15px; } hosts .svrGrpSettings,[data-is="hosts"] .svrGrpSettings{ background-color: white; padding: 25px; margin-bottom: 20px; clear: both; overflow:auto; } hosts .svrGrpServers,[data-is="hosts"] .svrGrpServers{ background-color: white; padding: 20px; overflow: hidden; min-height: 400px; } hosts .server_checkbox,[data-is="hosts"] .server_checkbox{ background-color: green; } hosts .server_checkbox input,[data-is="hosts"] .server_checkbox input{ padding: 0 !important; margin: 0 !important; } hosts .table input[type=text],[data-is="hosts"] .table input[type=text]{ background-color: yellow; border: none; outline:0; height: 45px; width: 95%; line-height: 45px; padding: 0; padding-left: 5px; margin: 0; font-size: 1em; cursor: pointer; } hosts .td-host,[data-is="hosts"] .td-host{ padding: 0; font-size: 0.8em; display: table-cell; border: 1px solid #ecedf1; background-color: #FFF; } hosts ul,[data-is="hosts"] ul{ list-style: none; padding: 0; margin: 0; background: #FFF; color: #000; width: 160px; z-index: 9999; } hosts ul li,[data-is="hosts"] ul li{ display: block; position: relative; float: left; background: #FFF; color: #000; width: 160px; background-repeat: no-repeat; background-position: right; } hosts li ul,[data-is="hosts"] li ul{ display: none; } hosts ul li a,[data-is="hosts"] ul li a{ height: 45px; display: block; text-decoration: none; white-space: nowrap; color: #000; } hosts ul li a:hover,[data-is="hosts"] ul li a:hover{ background: rgba(74, 80, 100, 1); } hosts li:hover > ul,[data-is="hosts"] li:hover > ul{ display: block; position: absolute; } hosts li:hover li,[data-is="hosts"] li:hover li{ float: none; } hosts li:hover a,[data-is="hosts"] li:hover a{ background: #363c52; color: white; } hosts li:hover li a:hover,[data-is="hosts"] li:hover li a:hover{ background: rgba(74, 80, 100, 1); } hosts .main-navigation li ul li,[data-is="hosts"] .main-navigation li ul li{ border-top: 0; } hosts ul ul ul,[data-is="hosts"] ul ul ul{ left: 100%; top: 0; } hosts ul:before,[data-is="hosts"] ul:before,hosts ul:after,[data-is="hosts"] ul:after{ content: " "; display: table; } hosts ul:after,[data-is="hosts"] ul:after{ clear: both; }', '', function(opts) {
        let currentValue
