...
riot.tag2('new-setting', '<div class="settings-container"> <fancy-input tag="Public Key" inputid="settings-view-key"> </fancy-input> </div> <fancy-button onclick="{createServerGroup}">Create</fancy-button> <fancy-button color="gray" onclick="{closeModal}">Cancel</fancy-button>', 'new-setting .settings-container,[data-is="new-setting"] .settings-container{ text-align: left; align-items: left; }', '', function(opts) {
});
riot.tag2('settings', '<div class="settings-group"> <fancy-input tag="KUBAM IP Address" inputid="srvgroup-new-name"></fancy-input> <fancy-button>Update</fancy-button> </div> <div class="settings-group"> <div class="settings-container-big"> <div class="table"> <div class="tr"> <div class="th">Public Key</div> </div> <div class="tr" each="{setting in this.opts.store.getState().settings}"> <div class="td">{public_key}</div> </div> </div> </div> </div> <add-button onclick="{addSetting}"> Add Setting </add-button>', 'settings .settings-group,[data-is="settings"] .settings-group{ padding-bottom: 15px; margin-bottom: 10px; background-color: white; padding: 20px; } settings .settings-container,[data-is="settings"] .settings-container{ background-color: white; padding: 20px; }', '', function(opts) {
