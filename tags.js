...
<<<<<<< HEAD
riot.tag2('new-host', '<form> <fancy-input tag="Hostname" input-id="servergroup-new-hostname"></fancy-input> <fancy-input tag="IP" input-id="servergroup-new-ip"></fancy-input> Role: <fancy-dropdown name="Role"> <option value="Master">Master</option> <option value="Worker">Worker</option> </fancy-dropdown><br> Server Group: <fancy-dropdown name="Server Group"> <option value="option1">Option 1</option> <option value="option2">Option 2</option> </fancy-dropdown><br> Images: <fancy-dropdown name="Images"> <option value="image1">Image 1</option> <option value="image2">Image 2</option> </fancy-dropdown><br> Network Group: <fancy-dropdown name="Network Group"> <option value="networkgroup1">Network Group 1</option> <option value="networkgroup2">Network Group 2</option> </fancy-dropdown><br> </form> <fancy-button onclick="{createServerGroup}">Create</fancy-button> <fancy-button color="gray" onclick="{closeModal}">Cancel</fancy-button>', 'new-host form,[data-is="new-host"] form{ align-content: center; align-items: center; }', '', function(opts) {
});
riot.tag2('infra-overview', '<div class="infra-group"> <div class="infra-container-big"> <table-search></table-search> <div class="table"> <div class="tr"> <div class="th"><input type="checkbox"> </div> <div class="th">Name</div> <div class="th">Description</div> <div class="th">Type</div> <div class="th">Health</div> <div class="th">Mgmt IP</div> <div class="th">Tenant</div> <div class="th">Firmware version</div> <div class="th">Action</div> </div> <div class="tr" each="{comp in this.opts.store.getState().infracomponents}"> <div class="td"><input type="checkbox"></div> <div class="td">{comp.name}</div> <div class="td">{comp.description}</div> <div class="td">{comp.type}</div> <div class="td">HEALTH</div> <div class="td">{comp.credentials.ip}</div> <div class="td">{comp.credentials.user}</div> <div class="td">FIRMWARE</div> <div class="td"> <img src="./icons/edit.svg" class="table-icon"> <img src="./icons/delete.svg" class="table-icon"> </div> </div> </div> </div> </div> <add-button onclick="{addController}">Add Controller</add-button>', 'infra-overview .tablewidth,[data-is="infra-overview"] .tablewidth{ width: 720px; } infra-overview .infra-group,[data-is="infra-overview"] .infra-group{ padding-bottom: 15px; } infra-overview .infra-container,[data-is="infra-overview"] .infra-container{ background-color: white; padding: 20px; } infra-overview .infra-container-big,[data-is="infra-overview"] .infra-container-big{ background-color: white; padding: 34px 20px; }', '', function(opts) {
=======
...
>>>>>>> bcdd71e3277f26da8dd7d79ef99281d64e101e28
...
riot.tag2('new-setting', '<div class="settings-container"> <fancy-input tag="KUBAM IP Address" inputid="settings-view-ip"> </fancy-input> <fancy-input tag="Public Key" inputid="settings-view-key"> </fancy-input> </div>', 'new-setting .settings-container,[data-is="new-setting"] .settings-container{ text-align: left; align-items: left; }', '', function(opts) {
});
<<<<<<< HEAD
riot.tag2('settings', '<div class="settings-group"> <div class="settings-container-big"> <h1 class="categoryHeader">Settings</h1> <table-search></table-search> <div class="table"> <div class="tr"> <div class="th">KUBAM IP Address</div> <div class="th">Public Key</div> </div> <div class="tr"> <div class="td"></div> <div class="td"></div> </div> </div> </div> </div> <add-button onclick="{addSetting}"> Add Setting </add-button>', 'settings .settings-group,[data-is="settings"] .settings-group{ padding-bottom: 15px; background-color: white; padding: 20px; } settings .settings-container,[data-is="settings"] .settings-container{ background-color: white; padding: 20px; }', '', function(opts) {
=======
riot.tag2('settings', '<h1 class="categoryHeader">Settings</h1> <div class="settings-group"> <div class="settings-container-big"> <table-search></table-search> <div class="table"> <div class="tr"> <div class="th">KUBAM IP Address</div> <div class="th">Public Key</div> </div> <div class="tr" each="{setting in this.opts.store.getState().settings}"> <div class="td">{ip}</div> <div class="td">{public_key}</div> </div> </div> </div> </div> <add-button onclick="{addSetting}">Add Setting</add-button>', 'settings .settings-group,[data-is="settings"] .settings-group{ padding-bottom: 15px; background-color: white; padding: 20px; } settings .settings-container,[data-is="settings"] .settings-container{ background-color: white; padding: 20px; }', '', function(opts) {
>>>>>>> bcdd71e3277f26da8dd7d79ef99281d64e101e28
