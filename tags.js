...
riot.tag2('new-setting', '<div class="settings-container"> <fancy-input tag="Public Key" inputid="settings-view-key"> </fancy-input> </div> <fancy-button onclick="{addPublicKey}">Create</fancy-button> <fancy-button color="gray" onclick="{closeModal}">Cancel</fancy-button>', 'new-setting .settings-container,[data-is="new-setting"] .settings-container{ text-align: left; align-items: left; }', '', function(opts) {
        this.closeModal = function() {
            document.getElementById('modal-shadow').style.display = 'None';
        }.bind(this)
