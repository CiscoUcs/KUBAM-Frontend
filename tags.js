...
riot.tag2('new-serverimage', '<form> <fancy-input tag="Name" inputid="mapping-name"> </fancy-input> <fancy-dropdown name="ISO" tag="ISO" inputid="mapping-iso"> <option value="CentOS">CentOS</option> <option value="VMware ESXi">VMware ESXi</option> <option each="{img in this.opts.store.getState().images}" riot-value="{img}">{img}</option> </fancy-dropdown><br> </form> <fancy-button onclick="{createImageMapping}">Create</fancy-button> <fancy-button color="gray" onclick="{closeModal}">Cancel</fancy-button>', 'new-serverimage form,[data-is="new-serverimage"] form{ text-align: left; }', '', function(opts) {
        store.dispatch({
            type: 'FETCH_IMAGES'
        })
...
riot.tag2('new-setting', '<div class="settings-container"> <fancy-input tag="KUBAM IP Address" inputid="settings-view-ip"> </fancy-input> <fancy-input tag="Public Key" inputid="settings-view-key"> </fancy-input> </div> <fancy-button onclick="{createServerGroup}">Create</fancy-button> <fancy-button color="gray" onclick="{closeModal}">Cancel</fancy-button>', 'new-setting .settings-container,[data-is="new-setting"] .settings-container{ text-align: left; align-items: left; }', '', function(opts) {
});
