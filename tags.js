...
riot.tag2('network', '<div class="network-group"> <h1 class="categoryHeader">New Network Group</h1> </div> <add-button onclick="{addNetworkGroup}"> Add Network Group </add-button> <hr> <div class="infra-group"> <div class="network-container-big"> <table-search></table-search> <div class="table"> <div class="tr"> <div class="th">Network Group Name</div> <div class="th">Netmask</div> <div class="th">Router</div> <div class="th">Name Server</div> <div class="th">NTP Server</div> <div class="th">Proxy Server</div> <div class="th">VLAN</div> </div> <div class="tr" each="{comp in this.opts.store.getState().infracomponents}"> <div class="td"></div> <div class="td"></div> <div class="td"></div> <div class="td"></div> <div class="td"></div> <div class="td"></div> <div class="td"></div> </div> </div> </div> </div> </div>', 'network .network-group,[data-is="network"] .network-group{ padding-bottom: 15px; } network .network-container,[data-is="network"] .network-container{ background-color: white; padding: 20px; }', '', function(opts) {
...
riot.tag2('settings', '<div class="settings-group"> <h1 class="categoryHeader">Settings</h1> <div class="settings-container"> <fancy-input tag="KUBAM IP Address" inputid="settings-view-ip"> </fancy-input> <fancy-input tag="Public Key" inputid="settings-view-key"> </fancy-input> </div> <hr> <div class="settings-group"> <div class="settings-container-big"> <table-search></table-search> <div class="table"> <div class="tr"> <div class="th">KUBAM IP Address</div> <div class="th">Public Key</div> </div> <div class="tr"> <div class="td"></div> <div class="td"></div> </div> </div> </div> </div> </div> <add-button onclick="{createSvrGroup}">Create new Server Group</add-button>', 'settings .settings-group,[data-is="settings"] .settings-group{ padding-bottom: 15px; } settings .settings-container,[data-is="settings"] .settings-container{ background-color: white; padding: 20px; }', '', function(opts) {
});
